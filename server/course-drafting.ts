...
function finalPrompt(
  ...
  return [
    ...
    'Верни только JSON по схеме. Обязательные ограничения, которые схема Codex CLI сама не проверяет:',
    '- client_id начинается со строчной латинской буквы, затем содержит только строчные латинские буквы, цифры и дефис; длина 1–64;',
    '- каждый prereqs — точный client_id другой темы из этого же ответа;',
    '- exam_weight — целое число от 0 до 3; difficulty — целое число от 1 до 3;',
    '- не более 60 тем; у каждой темы от 1 до 20 ссылок source_refs;',
