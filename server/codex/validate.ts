 ...
 * **только условия** — без ответов, подсказок и разборов, — решает каждое
 * задание сам и отдельно оценивает четыре вещи из спеки: условие однозначно,
 * ситуация не натянута, тема заявленная, содержание уместно подростку.
 *
...
/** Вердикт по одному заданию: собственный ответ проверяющего и четыре оценки. */
