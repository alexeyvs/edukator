...
export function buildGenerationPrompt(request: PromptRequest): string {
  ...
  return [
    ...
    [
      ...
      '- deep_hint — объект расширенной подсказки на 200–350 слов суммарно. Поля: rule — ' +
        'формулировка правила; explanation — дополнительная теория и границы применимости; ' +
        'examples — ровно два объекта с полями prompt, answer, walkthrough; checklist — 2–5 ' +
        'коротких пунктов самопроверки. Оба примера похожи по навыку, но используют только другие ' +
        'числа, слова и ситуации. Ни одна секция не называет и не выводит ответ текущего задания;',
