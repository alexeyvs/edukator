  ...
  return [
    ...
    [
      ...
      '- material_format — none, text или math. Для math пиши display-LaTeX без символов $. ' +
        'LaTeX допустим только в material при material_format=math и только на весь материал ' +
        'целиком: в instruction и в текстовом material разметки быть не должно — ни \\(…\\), ' +
        'ни \\[…\\], ни $…$, ни команд вроде \\frac. Формулу внутри предложения пиши обычным ' +
        'текстом: «использовали 13/40 деталей», «получилось 2,5 часа»;',
