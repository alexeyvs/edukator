...
const FORMAT_RULES: Record<AnswerFormat, string> = {
  ...
  choice:
    'ответ — ровно один из вариантов, перечисленных в самом условии. Регистр, «ё», апострофы ' +
    'и лишние пробелы сверка снимает сама, всё остальное сверяется знак в знак, поэтому ' +
    'записи в accept должны совпадать с вариантом условия буква в букву, включая знаки ' +
    'препинания. Два варианта не должны отличаться только буквой «ё» («все» и «всё»): ' +
    'сверка их не различает и засчитает неверный выбор. Если варианты ' +
